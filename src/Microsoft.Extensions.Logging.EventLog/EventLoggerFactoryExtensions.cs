...
namespace Microsoft.Extensions.Logging
{
    ...
    public static class EventLoggerFactoryExtensions
    {
        ...
        /// <summary>
        /// <para>
        /// This method is obsolete and will be removed in a future version. The recommended alternative is Microsoft.Extensions.Logging.AddEventLog().
        /// </para>
        /// Adds an event logger that is enabled for <see cref="LogLevel"/>.Information or higher.
        /// </summary>
        /// <param name="factory">The extension method argument.</param>
        [Obsolete("This method is obsolete and will be removed in a future version. The recommended alternative is Microsoft.Extensions.Logging.AddEventLog().")]
